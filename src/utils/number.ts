import { DECIMAL } from '@/config/baseInfo';
...
export function toFixed(value: number | string, fractionDigits: number): string {
...
export function formatNumericValue(data: string | number): FormattedNumericValue {
  if (data) {
